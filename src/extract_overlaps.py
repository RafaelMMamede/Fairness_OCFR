...
if __name__ == '__main__':
    ...
    parse.add_argument("--dataset_name",type=str, default="RFW0-RFW1")
    ...
    parse.add_argument('--occlusion_paths_R',type=list_of_strings, default= "../Occlusions/RFW1_occlusions_centered/African/,../Occlusions/RFW1_occlusions_centered/Asian/,../Occlusions/RFW1_occlusions_centered/Caucasian/,../Occlusions/RFW1_occlusions_centered/Indian/") #RIGHT IMAGES
            ...
            with open(args.pairs_paths[e]) as f:
                ...
                for j,line in enumerate(lines):
                    ...
                    if len(line_list)==3: #matching faces
                        ...
                        mask_R = Image.open(args.occlusion_paths_R[e] + ind + '/'+ind+'_000'+line_list[2]+'.png').convert('RGBA')


                        # Separate the image and alpha channel
                        _, _, _, a = mask_R.split()

                        # Convert the alpha channel to binary (0 for transparent, 1 for non-transparent)
                        mask_R = np.array(a) > 0  
                    ...
                    if len(line_list)==4: #non matching faces
                        ...
                        mask_R = Image.open(args.occlusion_paths_R[e] + ind2 + '/'+ind2+'_000'+line_list[3]+'.png').convert('RGBA')
